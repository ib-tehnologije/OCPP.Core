(function () {
  ...
  const startTranslations = {
    hr: {
      ...
      "start.r1Hint": "Nakon plaćanja pregledajte i potvrdite podatke tvrtke na sigurnoj stranici statusa sesije.",
      "start.r1MetadataHint": "Podaci kupca prikupljaju se nakon plaćanja, pregledavaju prije potvrde i spremaju uz rezervaciju, a ne kao podaci o plaćanju.",
    ...
    en: {
      ...
      "start.r1Hint": "After checkout, review and confirm your company details on the secure session status page.",
      "start.r1MetadataHint": "Buyer data is collected after checkout, reviewed before confirmation, and stored with the charging reservation rather than as payment data.",
    ...
    sl: {
      ...
      "start.r1Hint": "Po plačilu preglejte in potrdite podatke podjetja na varni strani statusa seje.",
      "start.r1MetadataHint": "Podatki kupca se zberejo po plačilu, pregledajo pred potrditvijo in shranijo ob rezervaciji, ne kot plačilni podatki.",
      "start.recoveryReservation": "Rezervacija",
      "start.recoveryStatus": "status",
    ...
    it: {
      ...
      "start.r1Hint": "Dopo il pagamento, verifica e conferma i dati aziendali nella pagina sicura dello stato sessione.",
      "start.r1MetadataHint": "I dati dell'acquirente vengono raccolti dopo il pagamento, verificati prima della conferma e salvati con la prenotazione, non come dati di pagamento.",
    ...
    de: {
      ...
      "start.r1Hint": "Prüfen und bestätigen Sie die Firmendaten nach dem Checkout auf der sicheren Sitzungsstatusseite.",
      "start.r1MetadataHint": "Käuferdaten werden nach dem Checkout erfasst, vor der Bestätigung geprüft und bei der Reservierung statt als Zahlungsdaten gespeichert.",
    ...
    fr: {
      ...
      "start.r1Hint": "Après le paiement, vérifiez et confirmez les données de l'entreprise sur la page sécurisée de statut de session.",
      "start.r1MetadataHint": "Les données de l'acheteur sont collectées après le paiement, vérifiées avant confirmation et stockées avec la réservation plutôt que comme données de paiement.",
