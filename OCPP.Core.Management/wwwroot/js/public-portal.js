(function () {
  ...
  const statusTranslations = {
    hr: {
      ...
      "status.r1.subtitle": "Podaci kupca za R1 račun potvrđuju se prije plaćanja na početnoj stranici.",
    ...
    en: {
      ...
      "status.r1.subtitle": "R1 invoice buyer details are confirmed before checkout on the start page.",
    ...
    sl: {
      ...
      "status.r1.subtitle": "Podatki kupca za R1 račun se potrdijo pred plačilom na začetni strani.",
    ...
    it: {
      ...
      "status.r1.subtitle": "I dati dell'acquirente per la fattura R1 vengono confermati prima del pagamento nella pagina iniziale.",
    ...
    de: {
      ...
      "status.r1.subtitle": "Die Käuferdaten für die R1-Rechnung werden vor dem Checkout auf der Startseite bestätigt.",
    ...
    fr: {
      ...
      "status.r1.subtitle": "Les données de l'acheteur pour la facture R1 sont confirmées avant le paiement sur la page de départ.",
