(function () {
  ...
  const startTranslations = {
    hr: {
      ...
      "start.rememberInvoiceBuyer": "Zapamti podatke tvrtke na ovom uređaju",
      "start.rememberInvoiceBuyerWarning": "Sprema se samo u ovom pregledniku. Drugi korisnici zajedničkog uređaja mogu vidjeti ove podatke.",
    ...
    en: {
      ...
      "start.rememberInvoiceBuyer": "Remember company details on this device",
      "start.rememberInvoiceBuyerWarning": "Stored only in this browser. Other users of a shared device may see these details.",
    ...
    sl: {
      ...
      "start.rememberInvoiceBuyer": "Zapomni si podatke podjetja v tej napravi",
      "start.rememberInvoiceBuyerWarning": "Shranjeno samo v tem brskalniku. Drugi uporabniki skupne naprave lahko vidijo te podatke.",
      "start.recoveryReservation": "Rezervacija",
      "start.recoveryStatus": "status",
    ...
    it: {
      ...
      "start.rememberInvoiceBuyer": "Ricorda i dati aziendali su questo dispositivo",
      "start.rememberInvoiceBuyerWarning": "Salvati solo in questo browser. Altri utenti di un dispositivo condiviso potrebbero vedere questi dati.",
    ...
    de: {
      ...
      "start.rememberInvoiceBuyer": "Firmendaten auf diesem Gerät speichern",
      "start.rememberInvoiceBuyerWarning": "Nur in diesem Browser gespeichert. Andere Nutzer eines gemeinsam verwendeten Geräts können diese Daten sehen.",
    ...
    fr: {
      ...
      "start.rememberInvoiceBuyer": "Mémoriser les données de l'entreprise sur cet appareil",
      "start.rememberInvoiceBuyerWarning": "Stockées uniquement dans ce navigateur. D'autres utilisateurs d'un appareil partagé peuvent voir ces données.",
  ...
  const statusTranslations = {
    hr: {
      ...
      "status.r1.taxIdentifierHelp": "Hrvatski OIB provjerava se kontrolnim brojem. Strani identifikatori izdaju se točno kako su uneseni i ne provjeravaju se u registru.",
    ...
    en: {
      ...
      "status.r1.taxIdentifierHelp": "Croatian OIB is checksum validated. Foreign identifiers are issued exactly as entered and are not registry-verified.",
    ...
    sl: {
      ...
      "status.r1.taxIdentifierHelp": "Hrvaški OIB se preveri s kontrolno številko. Tuji identifikatorji se izdajo točno tako, kot so vneseni, brez preverjanja registra.",
    ...
    it: {
      ...
      "status.r1.taxIdentifierHelp": "L'OIB croato viene verificato. Gli identificativi esteri vengono usati esattamente come inseriti e non sono verificati nei registri.",
    ...
    de: {
      ...
      "status.r1.taxIdentifierHelp": "Die kroatische OIB wird per Prüfziffer validiert. Ausländische Kennungen werden exakt wie eingegeben verwendet und nicht in Registern geprüft.",
    ...
    fr: {
      ...
      "status.r1.taxIdentifierHelp": "L'OIB croate est validé par clé de contrôle. Les identifiants étrangers sont utilisés exactement comme saisis et ne sont pas vérifiés dans un registre.",
