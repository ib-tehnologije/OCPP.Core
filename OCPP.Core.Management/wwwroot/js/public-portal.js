(function () {
  ...
  const startTranslations = {
    hr: {
      ...
      "start.r1Hint": "Prije nastavka na sigurno plaćanje unesite i potvrdite podatke kupca za račun.",
      "start.r1MetadataHint": "Podaci kupca potvrđuju se prije plaćanja i spremaju uz rezervaciju, a ne kao podaci o plaćanju.",
    ...
    en: {
      ...
      "start.r1Hint": "Enter and confirm the invoice buyer before continuing to secure payment.",
      "start.r1MetadataHint": "Buyer data is confirmed before checkout and stored with the charging reservation rather than as payment data.",
    ...
    sl: {
      ...
      "start.r1Hint": "Pred nadaljevanjem na varno plačilo vnesite in potrdite podatke kupca za račun.",
      "start.r1MetadataHint": "Podatki kupca se potrdijo pred plačilom in shranijo ob rezervaciji, ne kot plačilni podatki.",
      "start.recoveryReservation": "Rezervacija",
      "start.recoveryStatus": "status",
    ...
    it: {
      ...
      "start.r1Hint": "Inserisci e conferma i dati dell'acquirente prima di procedere al pagamento sicuro.",
      "start.r1MetadataHint": "I dati dell'acquirente vengono confermati prima del pagamento e salvati con la prenotazione, non come dati di pagamento.",
    ...
    de: {
      ...
      "start.r1Hint": "Geben Sie die Rechnungsdaten ein und bestätigen Sie sie, bevor Sie zur sicheren Zahlung fortfahren.",
      "start.r1MetadataHint": "Käuferdaten werden vor dem Checkout bestätigt und bei der Reservierung statt als Zahlungsdaten gespeichert.",
    ...
    fr: {
      ...
      "start.r1Hint": "Saisissez et confirmez les données de facturation avant de poursuivre vers le paiement sécurisé.",
      "start.r1MetadataHint": "Les données de l'acheteur sont confirmées avant le paiement et stockées avec la réservation plutôt que comme données de paiement.",
  ...
  const statusTranslations = {
    hr: {
      ...
      "status.vat.invalid": "VIES nije potvrdio ovaj PDV broj. Plaćanje nije blokirano; provjerite broj prije izdavanja računa.",
      "status.vat.unavailable": "VIES nije bio dostupan pa PDV broj nije bilo moguće provjeriti. Plaćanje je nastavljeno, a zadržan je broj provjerenog formata.",
      ...
      "status.r1.subtitle": "Podatke kupca za R1 račun možete provjeriti ili ispraviti dok račun nije izdan.",
      "status.r1.country": "Država tvrtke",
      "status.r1.companyName": "Pravni naziv tvrtke",
      "status.r1.street": "Adresa",
      "status.r1.postalCode": "Poštanski broj",
      "status.r1.city": "Grad",
      "status.r1.email": "E-mail za račun",
      "status.r1.taxIdentifier": "OIB / PDV / porezni identifikator",
      "status.r1.taxIdentifierHelp": "Hrvatski OIB provjerava se kontrolnim brojem. Strani PDV brojevi prije plaćanja provjeravaju se po formatu i normaliziraju. Ostali strani porezni identifikatori ostaju kako su uneseni.",
      "status.r1.registrationNumber": "Matični broj tvrtke (opcionalno)",
      "status.r1.vatRegistration": "Porezni identifikator je PDV identifikacijski broj",
      "status.r1.confirm": "Potvrđujem da su podaci za račun točni i da se račun može izdati točno kako su uneseni.",
      "status.r1.confirmRequired": "Potvrdite podatke za račun prije spremanja.",
      "status.r1.reviewEmpty": "Unesite podatke tvrtke za završni pregled.",
      ...
      "status.r1.savedMetadataPending": "R1 podaci su spremljeni. Sinkronizacija podataka plaćanja je na čekanju.",
      "status.r1.metadataRetryRequired": "R1 podaci su spremljeni, ali sinkronizacija podataka plaćanja nije zakazana. Pokušajte ponovno ili se obratite podršci.",
      "status.r1.changed": "Podaci za račun promijenjeni su u drugoj sesiji. Učitani su najnoviji podaci; pregledajte ih i pokušajte ponovno.",
      ...
      "status.r1.lockedUnavailable": "Status računa trenutačno nije moguće potvrditi pa su izmjene privremeno zaključane. Pokušajte poslije ili se obratite podršci.",
    ...
    en: {
      ...
      "status.vat.invalid": "VIES could not confirm this VAT registration. Checkout was not blocked; review the VAT number before the invoice is issued.",
      "status.vat.unavailable": "VIES was unavailable, so the VAT registration could not be checked. Checkout continued and the format-validated number was retained.",
      ...
      "status.r1.subtitle": "Review or correct the R1 invoice buyer details until the invoice is issued.",
      "status.r1.country": "Company country",
      "status.r1.companyName": "Legal company name",
      "status.r1.street": "Street address",
      "status.r1.postalCode": "Postal code",
      "status.r1.city": "City",
      "status.r1.email": "Billing email",
      "status.r1.taxIdentifier": "OIB / VAT / tax identifier",
      "status.r1.taxIdentifierHelp": "Croatian OIB is checksum validated. Foreign VAT numbers are format-checked and normalized before checkout. Other foreign tax identifiers remain as entered.",
      "status.r1.registrationNumber": "Legal registration number (optional)",
      "status.r1.vatRegistration": "The tax identifier is a VAT registration number",
      "status.r1.confirm": "I confirm these invoice details are correct and may be issued exactly as entered.",
      "status.r1.confirmRequired": "Confirm the invoice details before saving.",
      "status.r1.reviewEmpty": "Enter company details for final review.",
      ...
      "status.r1.savedMetadataPending": "R1 details were saved. Payment metadata synchronization is pending.",
      "status.r1.metadataRetryRequired": "R1 details were saved, but payment metadata synchronization was not queued. Try again or contact support.",
      "status.r1.changed": "Invoice details changed in another session. The latest details were loaded; review them and try again.",
      ...
      "status.r1.lockedUnavailable": "Invoice status cannot be verified right now, so editing is temporarily locked. Try again later or contact support.",
    ...
    sl: {
      ...
      "status.vat.invalid": "VIES ni potrdil te registracije za DDV. Plačilo ni bilo blokirano; pred izdajo računa preverite številko za DDV.",
      "status.vat.unavailable": "VIES ni bil dosegljiv, zato registracije za DDV ni bilo mogoče preveriti. Plačilo se je nadaljevalo, oblikovno preverjena številka pa je bila shranjena.",
      ...
      "status.r1.subtitle": "Podatke kupca za R1 račun lahko pregledate ali popravite, dokler račun ni izdan.",
      "status.r1.country": "Država podjetja",
      "status.r1.companyName": "Pravno ime podjetja",
      "status.r1.street": "Ulični naslov",
      "status.r1.postalCode": "Poštna številka",
      "status.r1.city": "Mesto",
      "status.r1.email": "E-pošta za račun",
      "status.r1.taxIdentifier": "OIB / DDV / davčna številka",
      "status.r1.taxIdentifierHelp": "Hrvaški OIB se preveri s kontrolno številko. Tuje številke za DDV se pred plačilom oblikovno preverijo in normalizirajo. Drugi tuji davčni identifikatorji ostanejo takšni, kot so vneseni.",
      "status.r1.registrationNumber": "Matična številka (neobvezno)",
      "status.r1.vatRegistration": "Davčna številka je identifikacijska številka za DDV",
      "status.r1.confirm": "Potrjujem, da so podatki za račun pravilni in se lahko izdajo točno tako, kot so vneseni.",
      "status.r1.confirmRequired": "Pred shranjevanjem potrdite podatke za račun.",
      "status.r1.reviewEmpty": "Vnesite podatke podjetja za končni pregled.",
      ...
      "status.r1.savedMetadataPending": "R1 podatki so shranjeni. Sinhronizacija podatkov o plačilu je v teku.",
      "status.r1.metadataRetryRequired": "R1 podatki so shranjeni, vendar sinhronizacija podatkov o plačilu ni bila uvrščena v čakalno vrsto. Poskusite znova ali se obrnite na podporo.",
      "status.r1.changed": "Podatki računa so bili spremenjeni v drugi seji. Naloženi so najnovejši podatki; preglejte jih in poskusite znova.",
      ...
      "status.r1.lockedUnavailable": "Stanja računa trenutno ni mogoče preveriti, zato je urejanje začasno zaklenjeno. Poskusite pozneje ali se obrnite na podporo.",
    ...
    it: {
      ...
      "status.vat.invalid": "VIES non ha confermato questa registrazione IVA. Il pagamento non è stato bloccato; verifica la partita IVA prima dell'emissione della fattura.",
      "status.vat.unavailable": "VIES non era disponibile, quindi non è stato possibile verificare la registrazione IVA. Il pagamento è proseguito e il numero validato nel formato è stato conservato.",
      ...
      "status.r1.subtitle": "Puoi verificare o correggere i dati dell'acquirente della fattura R1 finché la fattura non viene emessa.",
      "status.r1.country": "Paese dell'azienda",
      "status.r1.companyName": "Ragione sociale",
      "status.r1.street": "Indirizzo",
      "status.r1.postalCode": "Codice postale",
      "status.r1.city": "Città",
      "status.r1.email": "E-mail di fatturazione",
      "status.r1.taxIdentifier": "OIB / IVA / identificativo fiscale",
      "status.r1.taxIdentifierHelp": "L'OIB croato viene verificato con cifra di controllo. Le partite IVA estere vengono validate nel formato e normalizzate prima del pagamento. Gli altri identificativi fiscali esteri restano come inseriti.",
      "status.r1.registrationNumber": "Numero di registrazione legale (opzionale)",
      "status.r1.vatRegistration": "L'identificativo fiscale è un numero di partita IVA",
      "status.r1.confirm": "Confermo che i dati di fatturazione sono corretti e possono essere usati esattamente come inseriti.",
      "status.r1.confirmRequired": "Conferma i dati di fatturazione prima di salvare.",
      "status.r1.reviewEmpty": "Inserisci i dati aziendali per la verifica finale.",
      ...
      "status.r1.savedMetadataPending": "I dati R1 sono stati salvati. La sincronizzazione dei metadati di pagamento è in sospeso.",
      "status.r1.metadataRetryRequired": "I dati R1 sono stati salvati, ma la sincronizzazione dei metadati di pagamento non è stata accodata. Riprova o contatta l'assistenza.",
      "status.r1.changed": "I dati della fattura sono stati modificati in un'altra sessione. Sono stati caricati i dati più recenti; verificali e riprova.",
      ...
      "status.r1.lockedUnavailable": "Lo stato della fattura non può essere verificato ora, quindi la modifica è temporaneamente bloccata. Riprova più tardi o contatta l'assistenza.",
    ...
    de: {
      ...
      "status.vat.invalid": "VIES konnte diese USt-Registrierung nicht bestätigen. Der Bezahlvorgang wurde nicht blockiert; prüfen Sie die USt-IdNr. vor der Rechnungserstellung.",
      "status.vat.unavailable": "VIES war nicht verfügbar, daher konnte die USt-Registrierung nicht geprüft werden. Der Bezahlvorgang wurde fortgesetzt und die formatgeprüfte Nummer gespeichert.",
      ...
      "status.r1.subtitle": "Sie können die Käuferdaten der R1-Rechnung prüfen oder korrigieren, bis die Rechnung ausgestellt ist.",
      "status.r1.country": "Land des Unternehmens",
      "status.r1.companyName": "Rechtlicher Firmenname",
      "status.r1.street": "Straße und Hausnummer",
      "status.r1.postalCode": "Postleitzahl",
      "status.r1.city": "Ort",
      "status.r1.email": "E-Mail für die Rechnung",
      "status.r1.taxIdentifier": "OIB / USt-IdNr. / Steuer-ID",
      "status.r1.taxIdentifierHelp": "Die kroatische OIB wird per Prüfziffer validiert. Ausländische USt-IdNr. werden vor dem Bezahlen auf ihr Format geprüft und normalisiert. Andere ausländische Steuerkennungen bleiben wie eingegeben.",
      "status.r1.registrationNumber": "Handelsregisternummer (optional)",
      "status.r1.vatRegistration": "Die Steuerkennung ist eine Umsatzsteuer-Identifikationsnummer",
      "status.r1.confirm": "Ich bestätige, dass diese Rechnungsdaten korrekt sind und exakt wie eingegeben verwendet werden dürfen.",
      "status.r1.confirmRequired": "Bestätigen Sie die Rechnungsdaten vor dem Speichern.",
      "status.r1.reviewEmpty": "Geben Sie die Firmendaten für die abschließende Prüfung ein.",
      ...
      "status.r1.savedMetadataPending": "Die R1-Daten wurden gespeichert. Die Synchronisierung der Zahlungsmetadaten steht noch aus.",
      "status.r1.metadataRetryRequired": "Die R1-Daten wurden gespeichert, aber die Synchronisierung der Zahlungsmetadaten wurde nicht eingeplant. Versuchen Sie es erneut oder wenden Sie sich an den Support.",
      "status.r1.changed": "Die Rechnungsdaten wurden in einer anderen Sitzung geändert. Die neuesten Daten wurden geladen; prüfen Sie sie und versuchen Sie es erneut.",
      ...
      "status.r1.lockedUnavailable": "Der Rechnungsstatus kann derzeit nicht geprüft werden, daher ist die Bearbeitung vorübergehend gesperrt. Versuchen Sie es später oder wenden Sie sich an den Support.",
    ...
    fr: {
      ...
      "status.vat.invalid": "VIES n'a pas confirmé cet enregistrement TVA. Le paiement n'a pas été bloqué ; vérifiez le numéro de TVA avant l'émission de la facture.",
      "status.vat.unavailable": "VIES était indisponible, l'enregistrement TVA n'a donc pas pu être vérifié. Le paiement a continué et le numéro validé par format a été conservé.",
      ...
      "status.r1.subtitle": "Vous pouvez vérifier ou corriger les données de l'acheteur de la facture R1 jusqu'à son émission.",
      "status.r1.country": "Pays de l'entreprise",
      "status.r1.companyName": "Raison sociale",
      "status.r1.street": "Adresse",
      "status.r1.postalCode": "Code postal",
      "status.r1.city": "Ville",
      "status.r1.email": "E-mail de facturation",
      "status.r1.taxIdentifier": "OIB / TVA / identifiant fiscal",
      "status.r1.taxIdentifierHelp": "L'OIB croate est validé par clé de contrôle. Les numéros de TVA étrangers sont contrôlés par format et normalisés avant le paiement. Les autres identifiants fiscaux étrangers restent tels que saisis.",
      "status.r1.registrationNumber": "Numéro d'immatriculation légal (optionnel)",
      "status.r1.vatRegistration": "L'identifiant fiscal est un numéro de TVA",
      "status.r1.confirm": "Je confirme que ces données de facturation sont exactes et peuvent être utilisées telles quelles.",
      "status.r1.confirmRequired": "Confirmez les données de facturation avant l'enregistrement.",
      "status.r1.reviewEmpty": "Saisissez les données de l'entreprise pour la vérification finale.",
      ...
      "status.r1.savedMetadataPending": "Les données R1 ont été enregistrées. La synchronisation des métadonnées de paiement est en attente.",
      "status.r1.metadataRetryRequired": "Les données R1 ont été enregistrées, mais la synchronisation des métadonnées de paiement n'a pas été mise en file d'attente. Réessayez ou contactez l'assistance.",
      "status.r1.changed": "Les données de facturation ont été modifiées dans une autre session. Les données les plus récentes ont été chargées ; vérifiez-les et réessayez.",
      ...
      "status.r1.lockedUnavailable": "Le statut de la facture ne peut pas être vérifié pour le moment ; la modification est donc temporairement verrouillée. Réessayez plus tard ou contactez l'assistance.",
  ...
  function messageTranslationKey(value) {
    ...
    const keys = {
      ...
      "R1 invoice details were saved. Payment metadata synchronization is pending.": "status.r1.savedMetadataPending",
      "Buyer details were saved, but payment metadata could not be synchronized or queued. Retry this save or contact support.": "status.r1.metadataRetryRequired",
