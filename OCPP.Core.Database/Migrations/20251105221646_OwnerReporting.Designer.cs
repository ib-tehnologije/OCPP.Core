...
namespace OCPP.Core.Database.Migrations
{
    ...
    [Migration("20251105221646_OwnerReporting")]
    partial class OwnerReporting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OCPP.Core.Database.ChargeStationOwner", b =>
                {
                    b.Property<int>("OwnerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("LastReportMonth")
                        .HasColumnType("int");

                    b.Property<DateTime?>("LastReportSentAt")
                        .HasColumnType("datetime2");

                    b.Property<int?>("LastReportYear")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ProvisionPercentage")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ChargeStationOwner", (string)null);
                });
            ...
            modelBuilder.Entity("OCPP.Core.Database.ChargePoint", b =>
                {
                    b.HasOne("OCPP.Core.Database.ChargeStationOwner", "Owner")
