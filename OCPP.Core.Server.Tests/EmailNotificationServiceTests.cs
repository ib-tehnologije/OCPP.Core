    ...
    public class EmailNotificationServiceTests
    {
        ...
        public void SendPaymentAuthorized_WritesSinkWithOpenSessionLink()
        {
            ...
            try
            {
                ...
                Assert.Contains("Payments/Status?reservationId=abc", htmlBody, StringComparison.Ordinal);
                Assert.Contains("EV.Charge", htmlBody, StringComparison.Ordinal);
                Assert.Contains("Plaćanje autorizirano", htmlBody, StringComparison.Ordinal);
                Assert.Contains("Payment Authorized", htmlBody, StringComparison.Ordinal);
                Assert.DoesNotContain("OCPP Core Charging", htmlBody, StringComparison.Ordinal);
            }
            finally
            {
